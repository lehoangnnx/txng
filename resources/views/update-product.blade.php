                                ...
                                @foreach($images as $image)
                                    @if( $product->id == $image->foreign_id )
                                        <div class="thumbnail">
                                            ...
                                            <a href="/delete/image/{{$image->id}}" class="button_x" onclick="return ConfirmDelete();">X</a>
                                        </div>
                                    @endif
                                @endforeach
                            </div>
                                ...
                                @foreach($image_certificates as $image_certificate)
                                    @if( $product->id == $image_certificate->foreign_id )
                                        <div class="thumbnail">
                                            ...
                                            <a href="/delete/image/{{$image_certificate->id}}" class="button_x" onclick="return ConfirmDelete();">X</a>
                                        </div>
                                    @endif
                                @endforeach
                            </div>
